...
- **[DEPLOY.md](./docs/DEPLOY.md)** - Краткая инструкция по развёртыванию на Railway
- **[PROJECT_STATUS.md](./docs/PROJECT_STATUS.md)** - Статус проекта, что сделано и план разработки

### 📖 Подробная документация

- **[Архитектура.md](./docs/Архитектура.md)** - Архитектура системы
- **[Правки по архитектуре.md](./docs/Правки по архитектуре.md)** - Уточнения по архитектуре
- **[Концепция.md](./docs/Концепция.md)** - Концепция проекта
- **[Структура регистрации.md](./docs/Структура регистрации.md)** - Структура регистрации пользователей
